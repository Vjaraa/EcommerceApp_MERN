...
import ShoppingCartContext from '../components/ShoppingCartContext';  // Importar el contexto
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div className="flex">
                ...
                {/* Puedes agregar botones de color dinámicamente si tienes información de colores en tu API */}
              </div>
            ...
            <div className="flex">
              ...
              <button
                ...
                onClick={handleAddToCart}  // Llamar a la función addToCart
              >
                Agregar al carrito
              </button>
